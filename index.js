...
class Person {
  ...
  poop() { return this.stomach.splice(0, this.stomach.length); };
...
class Instructor extends Lambdasian{
  ...
  gradeAdjust(student){
    let randomGrade = (Math.random()*21)
    const upOrDown = Math.random() < 0.5 ? -1 : 1;
    randomGrade = randomGrade * upOrDown
...
class Student extends Lambdasian{
  ...
  listSubjects(){return `Loving ${this.favSubjects.join(', ')}`}
